/*
  ...
  1. New Functions
    - match_transcript_chunks: Searches for similar transcript chunks using vector similarity
    - Enables semantic search for chat functionality
...
BEGIN
  ...
  WHERE tc.video_id = match_transcript_chunks.video_id
